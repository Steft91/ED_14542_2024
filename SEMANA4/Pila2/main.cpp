...
int main() {
    IStack* stack = new Stack(); // Usar la interfaz IStack para crear la pila
    int opcion, dato;
    string linea;
    bool repite = true;
    ...
    do {
        ...
        case 1:
            ...
            stack->push(dato); // Llamar a push usando la interfaz IStack
            break;
        case 2:
            if (!stack->isEmpty()) {
                cout << "Dato removido: " << stack->pop() << endl; // Llamar a pop usando la interfaz IStack
            } else {
                cout << "La pila está vacía, no se puede hacer pop." << endl;
            }
            break;
        case 3:
            stack->print(); // Llamar a print usando la interfaz IStack
            break;
        case 4:
            repite = true;
            do {
            ...
            if (stack->search(dato)) { // Llamar a search usando la interfaz IStack
    ...
    delete stack; // Liberar la memoria al final del programa
    return 0;
}
